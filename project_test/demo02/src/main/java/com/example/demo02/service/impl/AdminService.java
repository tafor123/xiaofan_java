...
import com.example.demo02.mapper.AdminMapper;
import com.example.demo02.service.IAdminService;
import com.example.demo02.utils.TokenUtils;
...
public class AdminService implements IAdminService {
    ...
    private static final String PASS_SALT="qinQe";
    ...
    public void save(Admin obj) {
      ...
      obj.setPassword(securePass(obj.getPassword())); //设置md5密码，加盐
        try {
